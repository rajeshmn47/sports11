        ...
        <View style={{ ...styles.container, width: width }}>
            <TouchableOpacity onPress={() => navigation.navigate('Home')}>
                <View style={route.name == "Home" ? styles.selected : styles.iconContainer}>
                    <View style={{ marginBottom: 10 }}>
                        <Image source={require('../assets/whiteball.png')} style={{ width: 24, height: 24 }} />
                    </View>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('MyMatches', { userId: user?._id })}>
                <View style={route.name == "MyMatches" ? styles.selected : styles.iconContainer}>
                    <View style={{ marginBottom: 10 }}>
                        <Image source={require('../assets/prize.png')} style={{ width: 24, height: 24 }} />
                    </View>
                    <Text style={route.name == "MyMatches" ? styles.selectedColor : styles.textColor}>My Matches</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('Post', { userId: user?._id })}>
                <View style={route.name == "Post" ? styles.selected : styles.iconContainer}>
                    <View style={{ marginBottom: 10 }}>
                        <Image source={require('../assets/wallet.png')} style={{ width: 28, height: 28 }} />
                    </View>
                    <Text style={route.name == "Post" ? styles.selectedColor : styles.textColor}>Wallet</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('Post', { userId: user?._id })}>
                <View style={route.name == "Post" ? styles.selected : styles.iconContainer}>
                    <View style={{ marginBottom: 10 }}>
                        <Image source={require('../assets/account.png')} style={{ width: 28, height: 28 }} />
                    </View>
                    <Text style={route.name == "Post" ? styles.selectedColor : styles.textColor}>Account</Text>
                </View>
            </TouchableOpacity>
        </View>
    )
